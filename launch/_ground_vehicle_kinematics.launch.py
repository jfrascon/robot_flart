...
def generate_launch_description() -> LaunchDescription:
    """Declare the robot-scoped inputs used to start the Forki3 kinematics node."""
...
def _include_kinematics() -> IncludeLaunchDescription:
    """Include three-swerve kinematics with every child launch input mapped explicitly."""
        ...
        PythonLaunchDescriptionSource(
            PathJoinSubstitution(
                [
                    ...
                    'launch',
                    'three_swerve_kinematics.launch.py',
                ]
            )
        ),
        launch_arguments={
