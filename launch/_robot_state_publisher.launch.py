...
from robot_forki3.model_utils import get_models
...
def _build_xacro_command(
    ...
    # The rest of the xacro arguments are loaded from the optional `robot_xacro_args_file` YAML.
...
def _launch_node(ctx: LaunchContext) -> list[LaunchDescriptionEntity]:
    ...
    xacro_file = Path(get_package_share_directory('robot_forki3')).joinpath(
