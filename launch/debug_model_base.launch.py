"""
Launch the Forki3 base model in a package-local Gazebo debug world.
    ...
    actions: list[LaunchDescriptionEntity] = [
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare('robot_forki3'), 'config', 'model_base', 'default_params.yaml']
            ),
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare('robot_forki3'), 'config', 'model_base', 'default_bridge.yaml']
            ),
