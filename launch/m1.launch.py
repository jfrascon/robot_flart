    ...
    ldes: list[LaunchDescriptionEntity] = [
        ...
        DeclareLaunchArgument(
            ...
            default_value=os.path.join(
                get_package_share_directory('robot_forklift_simple_3sw'), 'config', 'example_m1.yaml'
            ),
        ...
        DeclareLaunchArgument(
            'bridge_file',
            default_value=os.path.join(
                get_package_share_directory('robot_forklift_simple_3sw'), 'config', 'example_m1_bridge.yaml'
            ),
