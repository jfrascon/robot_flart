    ...
    ldes: list[LaunchDescriptionEntity] = [
        ...
        DeclareLaunchArgument(
            ...
            default_value=os.path.join(
                get_package_share_directory('robot_forklift_simple_3sw'), 'config', 'example_m2.yaml'
            ),
        ...
        DeclareLaunchArgument(
            'bridge_file',
            default_value=os.path.join(
                get_package_share_directory('robot_forklift_simple_3sw'), 'config', 'example_m2_bridge.yaml'
            ),
        ...
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution([FindPackageShare('robot_forklift_simple_3sw'), 'launch', '_rsp.launch.py'])
                ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution([FindPackageShare('robot_forklift_simple_3sw'), 'launch', '_bridge.launch.py'])
                ),
                launch_arguments={
                    'use_sim_time': LaunchConfiguration('use_sim_time'),
                    'namespace': LaunchConfiguration('namespace'),
