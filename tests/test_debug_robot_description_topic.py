...
@pytest.mark.parametrize(
    'launch_file', ['debug_model_base.launch.py', 'debug_model_sensors1.launch.py']
)
...
@pytest.mark.parametrize(
    ...
    [
        ('robot_description', '/sim_debug/forki3/robot_description'),
        ('rdesc', '/sim_debug/forki3/rdesc'),
        ('nested/rdesc', '/sim_debug/forki3/nested/rdesc'),
        ('/rdesc', '/rdesc'),
    ],
)
